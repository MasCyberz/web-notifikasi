    ...
    <div class="page-body">
        <div class="col-12 col-lg-8 container-xl">
            ...
            <form action="{{ route('management-user-store') }}" method="POST" class="card">
                ...
                <div class="card-body">
                    <x-Input label="Name" name="name" type="text" placeholder="Isi Nama Anda Disini" class="" required=required/>
                    <x-Input label="Email" name="email" type="email" placeholder="Isi Email Anda Disini" class="" />
        
                    <x-Input label="Password" name="password" type="password" placeholder="Isi Password Anda Disini" required=required class="" />
                </div>
